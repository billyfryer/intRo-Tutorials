...
Sharing both code and results are super important when doing data analysis of any kind, but especially in sports analytics. In intRo 2, we went over some basics of R Markdown in order to share results with coaches. Now, we want to share our work, specifically the code, with other sports analytics people. This can be to show off all of the hard work we have done or to collaborate with partners on a project by working together. The website most often used for this is github.com. Once you have your code on Github, we will discuss (very briefly) about other places to share your work, namely Twitter.
